...
CURRENT_ADMIN_IDENTIFIERS="$(get_current_env_var ADMIN_IDENTIFIERS)"
CURRENT_BUDGET_ADMIN_IDENTIFIERS="$(get_current_env_var BUDGET_ADMIN_IDENTIFIERS)"
...
ADMIN_IDENTIFIERS_INPUT="${ADMIN_IDENTIFIERS:-}"
BUDGET_ADMIN_IDENTIFIERS_INPUT="${BUDGET_ADMIN_IDENTIFIERS:-}"
...
ADMIN_IDENTIFIERS="${ADMIN_IDENTIFIERS_INPUT:-${CURRENT_ADMIN_IDENTIFIERS:-}}"
BUDGET_ADMIN_IDENTIFIERS="${BUDGET_ADMIN_IDENTIFIERS_INPUT:-${CURRENT_BUDGET_ADMIN_IDENTIFIERS:-}}"
...
if [[ -n "${ADMIN_IDENTIFIERS}" ]]; then
  ENV_VARS_ARG="${ENV_VARS_ARG}##ADMIN_IDENTIFIERS=${ADMIN_IDENTIFIERS}"
fi
if [[ -n "${BUDGET_ADMIN_IDENTIFIERS}" ]]; then
  ENV_VARS_ARG="${ENV_VARS_ARG}##BUDGET_ADMIN_IDENTIFIERS=${BUDGET_ADMIN_IDENTIFIERS}"
fi
...
if [[ -n "${ADMIN_IDENTIFIERS}" ]]; then
  echo "[INFO] ADMIN_IDENTIFIERS: ${ADMIN_IDENTIFIERS}"
fi
if [[ -n "${BUDGET_ADMIN_IDENTIFIERS}" ]]; then
  echo "[INFO] BUDGET_ADMIN_IDENTIFIERS: ${BUDGET_ADMIN_IDENTIFIERS}"
fi
