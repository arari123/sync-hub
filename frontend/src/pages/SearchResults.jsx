    ...
    useEffect(() => {
        const fetchResults = async () => {
            ...
            try {
                ...
                setResults([]);
                setError(getErrorMessage(err, 'We could not complete your search request. Please check your connection and try again.'));
            } finally {
                setIsLoading(false);
            }
        };
        ...
        <div className="space-y-6">
            ...
            {isLoading ? (
                ...
                <div className="flex flex-col items-center justify-center p-12 border rounded-xl bg-destructive/5 text-center">
                    ...
                    <h3 className="font-bold text-lg text-destructive mb-2">Unavailable to Search</h3>
